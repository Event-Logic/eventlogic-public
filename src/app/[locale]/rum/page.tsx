...
export async function generateMetadata({
  ...
  const canonicalPath = locale === 'en' ? '/rooms' : '/rum';
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {rooms.map((room) => (
              <RoomCard
                ...
                roomTypeId={`room${room.id}`} // Placeholder - replace with actual Sirvoy room type IDs
              />
            ))}
          </div>
        </div>
        ...
        <div className="mt-16 bg-white rounded-lg shadow-lg p-6">
          <h2 className="text-2xl font-bold mb-4 text-center">{t('breakfast.title')}</h2>
          <p className="text-gray-700 mb-4">
            {t('breakfast.note')}
          </p>
          <p className="text-gray-700 mb-2">{t('breakfast.dates')}</p>
          <ul className="list-disc pl-6 mb-4 text-gray-700">
            <li>{t('breakfast.period1')}</li>
            <li>{t('breakfast.period2')}</li>
          </ul>
        ...
        {/* Hotel Amenities */}
        <div className="mt-16">
          <h2 className="text-3xl font-bold mb-8 text-center">{t('amenities.title')}</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="p-4">
              ...
              <h3 className="font-semibold">{t('amenities.wifi')}</h3>
            </div>
            <div className="p-4">
              <svg className="h-10 w-10 mx-auto mb-3 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 15.546c-.523 0-1.046.151-1.5.454a2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.701 2.701 0 00-1.5-.454M9 6v2m3-2v2m3-2v2M9 3h.01M12 3h.01M15 3h.01M21 21v-7a2 2 0 00-2-2H5a2 2 0 00-2 2v7h18zm-3-9v-2a2 2 0 00-2-2H8a2 2 0 00-2 2v2h12z" />
              </svg>
              <h3 className="font-semibold">{t('amenities.breakfast')}</h3>
            </div>
            <div className="p-4">
              <svg className="h-10 w-10 mx-auto mb-3 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
              <h3 className="font-semibold">{t('amenities.restaurant')}</h3>
            </div>
            <div className="p-4">
              <svg className="h-10 w-10 mx-auto mb-3 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
              <h3 className="font-semibold">{t('amenities.meeting')}</h3>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-gray-700 mt-2">{t('contact.address')}</p>
        </div>
      </div>
    </div>
  );
