      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="mb-16 text-center">
          <h2 className="text-3xl font-bold mb-6 text-blue-900">
            {lang === 'en' ? 'Your Celebration, Your Way' : 'Din Fest, Dina Regler'}
          </h2>
          ...
          <div className="mt-8">
            ...
            >
              {lang === 'en' ? 'Plan Your DIY Celebration' : 'Planera din gör-det-själv-fest'}
            </Link>
          </div>
        </div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center">
            {lang === 'en' ? 'What Makes Our DIY Celebrations Special' : 'Vad gör våra gör-det-själv-fester speciella'}
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-8 relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold mb-4 text-blue-900">
                {lang === 'en' ? 'Stunning Setting' : 'Fantastisk miljö'}
              </h3>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-20 h-20 bg-blue-600 transform rotate-45 translate-x-10 -translate-y-10"></div>
              <h3 className="text-2xl font-bold mb-4 text-blue-900">
                {lang === 'en' ? 'Accommodation Options' : 'Boendealternativ'}
              </h3>
              <p className="mb-4 text-gray-700">
                {lang === 'en' 
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-20 h-20 bg-blue-600 transform rotate-45 translate-x-10 -translate-y-10"></div>
              <h3 className="text-2xl font-bold mb-4 text-blue-900">
                {lang === 'en' ? 'Your Choice of Food & Drink' : 'Ditt val av mat och dryck'}
              </h3>
              <p className="mb-4 text-gray-700">
                {lang === 'en' 
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-20 h-20 bg-blue-600 transform rotate-45 translate-x-10 -translate-y-10"></div>
              <h3 className="text-2xl font-bold mb-4 text-blue-900">
                {lang === 'en' ? 'Flexible Spaces' : 'Flexibla utrymmen'}
              </h3>
              <p className="mb-4 text-gray-700">
                {lang === 'en' 
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center">
            {lang === 'en' ? 'Perfect for Any Occasion' : 'Perfekt för alla tillfällen'}
          </h2>
          
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-xl font-bold mb-2 text-blue-900">
                {lang === 'en' ? 'Birthday Celebrations' : 'Födelsedagsfirande'}
              </h3>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-xl font-bold mb-2 text-blue-900">
                {lang === 'en' ? 'Anniversary Parties' : 'Jubileumsfester'}
              </h3>
              <p className="text-gray-700 mb-4">
                {lang === 'en' 
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-xl font-bold mb-2 text-blue-900">
                {lang === 'en' ? 'Family Reunions' : 'Familjemöten'}
              </h3>
              <p className="text-gray-700 mb-4">
                {lang === 'en' 
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center">
            {lang === 'en' ? 'Celebration Inspiration' : 'Festinspiration'}
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gray-200 h-64 rounded-lg flex items-center justify-center">
              <p className="text-gray-600 font-semibold">
                {lang === 'en' ? 'Image: Seaside Party' : 'Bild: Fest vid havet'}
              </p>
            </div>
            
            <div className="bg-gray-200 h-64 rounded-lg flex items-center justify-center">
              <p className="text-gray-600 font-semibold">
                {lang === 'en' ? 'Image: Historic Hall Banquet' : 'Bild: Bankett i historisk sal'}
              </p>
            </div>
            
            <div className="bg-gray-200 h-64 rounded-lg flex items-center justify-center">
              <p className="text-gray-600 font-semibold">
                {lang === 'en' ? 'Image: Sunset Celebration' : 'Bild: Firande i solnedgången'}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          <h2 className="text-2xl font-bold mb-4">
            {lang === 'en' ? 'Plan Your Celebration' : 'Planera din fest'}
          </h2>
