  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        {/* Booking Widget - Moved up for prominence */}
        <div className="bg-white rounded-lg shadow-xl p-6 md:p-8 mb-16 relative z-10">
          <h2 className="text-2xl font-bold mb-6 text-center">{lang === 'en' ? 'Book Your Stay' : 'Boka din vistelse'}</h2>
          
          {/* Sirvoy Booking Form */}
          <div id="sirvoy-container" className="min-h-[500px] w-full">
            {/* Loading indicator while Sirvoy loads */}
            <div className="flex justify-center items-center h-32 mb-8">
              <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-blue-900"></div>
            </div>
          </div>

          {/* Sirvoy Booking Script with improved parameters */}
          <Script
            id="sirvoy-script"
          ...
          <div className="mt-8 text-center">
            ...
            >
              {lang === 'en' ? 'View Our Rooms' : 'Se våra rum'}
            </Link>
          </div>
        </div>
