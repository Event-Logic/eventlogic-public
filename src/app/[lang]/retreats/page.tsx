      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="mb-16 text-center">
          <h2 className="text-3xl font-bold mb-6 text-blue-900">
            {lang === 'en' ? 'Your Retreat, Your Way' : 'Din Retreat, Dina Regler'}
          </h2>
          ...
          <div className="mt-8">
            ...
            >
              {lang === 'en' ? 'Plan Your DIY Retreat' : 'Planera din gör-det-själv-retreat'}
            </Link>
          </div>
        </div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center">
            {lang === 'en' ? 'What Makes Our DIY Retreats Special' : 'Vad gör våra gör-det-själv-retreats speciella'}
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-8 relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold mb-4 text-blue-900">
                {lang === 'en' ? 'Restorative Environment' : 'Återhämtande miljö'}
              </h3>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-20 h-20 bg-blue-600 transform rotate-45 translate-x-10 -translate-y-10"></div>
              <h3 className="text-2xl font-bold mb-4 text-blue-900">
                {lang === 'en' ? 'Comfortable Accommodations' : 'Bekvämt boende'}
              </h3>
              <p className="mb-4 text-gray-700">
                {lang === 'en' 
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-20 h-20 bg-blue-600 transform rotate-45 translate-x-10 -translate-y-10"></div>
              <h3 className="text-2xl font-bold mb-4 text-blue-900">
                {lang === 'en' ? 'Customizable Spaces' : 'Anpassningsbara utrymmen'}
              </h3>
              <p className="mb-4 text-gray-700">
                {lang === 'en' 
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-20 h-20 bg-blue-600 transform rotate-45 translate-x-10 -translate-y-10"></div>
              <h3 className="text-2xl font-bold mb-4 text-blue-900">
                {lang === 'en' ? 'Nourishing Food Options' : 'Näringsrika matalternativ'}
              </h3>
              <p className="mb-4 text-gray-700">
                {lang === 'en' 
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mt-8 text-center">
            <h3 className="text-2xl font-bold mb-4 text-blue-900">
              {lang === 'en' ? 'Your Program, Your Pace' : 'Ditt program, din takt'}
            </h3>
            <p className="text-lg text-gray-700 max-w-4xl mx-auto">
              {lang === 'en' 
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center">
            {lang === 'en' ? 'Perfect for Various Wellness Experiences' : 'Perfekt för olika wellnessupplevelser'}
          </h2>
          
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-xl font-bold mb-2 text-blue-900">
                {lang === 'en' ? 'Yoga & Meditation Retreats' : 'Yoga- och meditationsretreats'}
              </h3>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-xl font-bold mb-2 text-blue-900">
                {lang === 'en' ? 'Creative Workshops' : 'Kreativa workshops'}
              </h3>
              <p className="text-gray-700 mb-4">
                {lang === 'en' 
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-xl font-bold mb-2 text-blue-900">
                {lang === 'en' ? 'Team Building & Corporate Wellness' : 'Teambuilding och företagswellness'}
              </h3>
              <p className="text-gray-700 mb-4">
                {lang === 'en' 
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center">
            {lang === 'en' ? 'Retreat Inspiration' : 'Retreatinspiration'}
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gray-200 h-64 rounded-lg flex items-center justify-center">
              <p className="text-gray-600 font-semibold">
                {lang === 'en' ? 'Image: Seaside Yoga' : 'Bild: Yoga vid havet'}
              </p>
            </div>
            
            <div className="bg-gray-200 h-64 rounded-lg flex items-center justify-center">
              <p className="text-gray-600 font-semibold">
                {lang === 'en' ? 'Image: Mindfulness Workshop' : 'Bild: Mindfulness-workshop'}
              </p>
            </div>
            
            <div className="bg-gray-200 h-64 rounded-lg flex items-center justify-center">
              <p className="text-gray-600 font-semibold">
                {lang === 'en' ? 'Image: Coastal Meditation' : 'Bild: Meditation vid kusten'}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          <h2 className="text-2xl font-bold mb-4">
            {lang === 'en' ? 'Plan Your Retreat' : 'Planera din retreat'}
          </h2>
