...
export default async function RestaurangPage({
  ...
  const t = dict.restaurang || {
    title: lang === 'en' ? 'Restaurant' : 'Wärds Restaurang',
    subtitle: lang === 'en' ? 'Welcome to our restaurant in Mollösund' : 'Välkommen till vår restaurang i Mollösund',
    status: lang === 'en' ? 'The restaurant is closed for the season' : 'Restaurangen är stängd för säsongen',
    note: lang === 'en' ? 'We can help you realize your dream event!' : 'Vi hjälper dig att förverkliga just din drömfest!',
    about: {
      title: lang === 'en' ? 'About Our Restaurant' : 'Om vår restaurang',
    ...
    events: {
      title: lang === 'en' ? 'Private Events' : 'Privata evenemang',
      description: lang === 'en'
      ...
      options: [
        {
          title: lang === 'en' ? 'Birthdays' : 'Födelsedagar',
          description: lang === 'en'
        ...
        {
          title: lang === 'en' ? 'Weddings' : 'Bröllop',
          description: lang === 'en'
        ...
        {
          title: lang === 'en' ? 'Corporate Events' : 'Företagsevent',
          description: lang === 'en'
    ...
    menu: {
      title: lang === 'en' ? 'Sample Menu' : 'Exempel på meny',
      description: lang === 'en'
      ...
      mains: {
        title: lang === 'en' ? 'Main Courses' : 'Huvudrätter',
        items: [
          {
            name: lang === 'en' ? 'Catch of the Day' : 'Dagens fångst',
            description: lang === 'en'
              ? 'Served with seasonal vegetables and butter sauce'
              : 'Serveras med säsongens primörer och smörsås'
          },
          {
            name: lang === 'en' ? 'Lobster Soup' : 'Hummersoppa',
            description: lang === 'en'
              ? 'With hand-peeled shrimp and aioli'
              : 'Med handskalade räkor och aioli'
          },
          {
            name: lang === 'en' ? 'Grilled Beef Tenderloin' : 'Grillad oxfilé',
            description: lang === 'en'
      ...
      desserts: {
        title: lang === 'en' ? 'Desserts' : 'Desserter',
        items: [
          {
            name: lang === 'en' ? 'Crème Brûlée' : 'Crème brûlée',
            description: lang === 'en'
              ? 'With seasonal berries'
              : 'Med säsongens bär'
          },
          {
            name: lang === 'en' ? 'Chocolate Fondant' : 'Chokladfondant',
            description: lang === 'en'
              ? 'With vanilla ice cream and raspberry coulis'
              : 'Med vaniljglass och halloncoulis'
          },
          {
            name: lang === 'en' ? 'Cheese Platter' : 'Ostbricka',
            description: lang === 'en'
    ...
    contact: {
      title: lang === 'en' ? 'Book Your Event With Us' : 'Boka ditt event hos oss',
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-80 md:h-96 bg-gradient-to-b from-blue-800 to-blue-600 rounded-lg flex items-center justify-center">
              <p className="text-white text-xl font-semibold">
                {lang === 'en' ? 'Mollösund Restaurant' : 'Restaurang Mollösund'}
              </p>
            </div>
          </div>
        </div>
