...
export default async function KonferensPage({
  ...
  const t = dict.konferens || {
    title: lang === 'en' ? 'Conference' : 'Konferens',
    subtitle: lang === 'en' ? 'Tailored conference packages on the West Coast' : 'Skräddarsydda konferenspaket på Västkusten',
    intro: lang === 'en' 
    ...
    packages: {
      title: lang === 'en' ? 'Conference Packages' : 'Konferenspaket',
      included: lang === 'en' ? 'Our conference package includes:' : 'I konferenspaketet ingår:',
      items: [
        lang === 'en' ? 'Accommodation in shared double room' : 'Boende med del i dubbelrum',
        lang === 'en' ? 'Conference room' : 'Konferenslokal',
        lang === 'en' ? 'Lunch' : 'Lunch',
        lang === 'en' ? 'Morning and afternoon coffee' : 'För- och eftermiddagsfika',
        lang === 'en' ? 'Three-course dinner' : 'Trerättersmiddag',
        lang === 'en' ? 'Breakfast' : 'Frukost'
      ],
      day: {
        title: lang === 'en' ? 'Day Conference' : 'Dagkonferens',
        description: lang === 'en' 
        ...
        includes: [
          lang === 'en' ? 'Conference room' : 'Konferenslokal',
          lang === 'en' ? 'Morning coffee' : 'Förmiddagsfika',
          lang === 'en' ? 'Lunch' : 'Lunch',
          lang === 'en' ? 'Afternoon coffee' : 'Eftermiddagsfika'
        ],
        price: lang === 'en' ? 'From 595 SEK per person' : 'Från 595 kr per person'
      },
      overnight: {
        title: lang === 'en' ? '24-Hour Conference' : 'Dygnskonferens',
        description: lang === 'en' 
        ...
        price: lang === 'en' ? 'From 2495 SEK per person' : 'Från 2495 kr per person'
      }
    },
    facilities: {
      title: lang === 'en' ? 'Our Conference Facilities' : 'Våra konferenslokaler',
      mainHall: {
        title: lang === 'en' ? 'Main Hall' : 'Stora salen',
        description: lang === 'en' 
        ...
        features: [
          lang === 'en' ? 'Up to 40 people' : 'Upp till 40 personer',
          lang === 'en' ? 'Projector and screen' : 'Projektor och duk',
          lang === 'en' ? 'Sound system' : 'Ljudanläggning',
          'WiFi'
        ]
      },
      seaRoom: {
        title: lang === 'en' ? 'Sea Room' : 'Havsrummet',
        description: lang === 'en' 
        ...
        features: [
          lang === 'en' ? 'Up to 12 people' : 'Upp till 12 personer',
          lang === 'en' ? 'Sea view' : 'Havsutsikt',
          'Smart TV',
          'Whiteboard',
          'WiFi'
        ]
    ...
    activities: {
      title: lang === 'en' ? 'Activities' : 'Aktiviteter',
      description: lang === 'en' 
      ...
      options: [
        {
          title: lang === 'en' ? 'Archipelago Safari' : 'Skärgårdssafari',
          description: lang === 'en' 
        ...
        {
          title: lang === 'en' ? 'Cooking Class' : 'Matlagningskurs',
          description: lang === 'en' 
        ...
        {
          title: lang === 'en' ? 'Guided Walk' : 'Guidad vandring',
          description: lang === 'en' 
    ...
    contact: {
      title: lang === 'en' ? 'Book Your Conference' : 'Boka er konferens',
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="mb-16 text-center">
          <h2 className="text-3xl font-bold mb-6 text-blue-900">
            {lang === 'en' ? 'Your Event, Your Way' : 'Ditt Event, Dina Regler'}
          </h2>
          ...
          <div className="mt-8">
            ...
            >
              {lang === 'en' ? 'Plan Your DIY Conference' : 'Planera din gör-det-själv-konferens'}
            </Link>
          </div>
        </div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center">
            {lang === 'en' ? 'What Makes Our DIY Conferences Special' : 'Vad gör våra gör-det-själv-konferenser speciella'}
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-8 relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold mb-4 text-blue-900">
                {lang === 'en' ? 'Space to Create' : 'Utrymme att skapa'}
              </h3>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-20 h-20 bg-blue-600 transform rotate-45 translate-x-10 -translate-y-10"></div>
              <h3 className="text-2xl font-bold mb-4 text-blue-900">
                {lang === 'en' ? 'Sleep by the Sea' : 'Sov vid havet'}
              </h3>
              <p className="mb-4 text-gray-700">
                {lang === 'en' 
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-20 h-20 bg-blue-600 transform rotate-45 translate-x-10 -translate-y-10"></div>
              <h3 className="text-2xl font-bold mb-4 text-blue-900">
                {lang === 'en' ? 'Ditch the Stale Catering' : 'Skippa den tråkiga cateringen'}
              </h3>
              <p className="mb-4 text-gray-700">
                {lang === 'en' 
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-20 h-20 bg-blue-600 transform rotate-45 translate-x-10 -translate-y-10"></div>
              <h3 className="text-2xl font-bold mb-4 text-blue-900">
                {lang === 'en' ? 'Beyond Trust Falls' : 'Bortom tillitsövningar'}
              </h3>
              <p className="mb-4 text-gray-700">
                {lang === 'en' 
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mt-8 text-center">
            <h3 className="text-2xl font-bold mb-4 text-blue-900">
              {lang === 'en' ? 'Your Schedule, Your Rules' : 'Ditt schema, dina regler'}
            </h3>
            <p className="text-lg text-gray-700 max-w-4xl mx-auto">
              {lang === 'en' 
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center">
            {lang === 'en' ? 'Coastal Adventures' : 'Äventyr vid kusten'}
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-xl font-bold mb-2 text-blue-900">
                {lang === 'en' ? 'Archipelago Safari' : 'Skärgårdssafari'}
              </h3>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-xl font-bold mb-2 text-blue-900">
                {lang === 'en' ? 'Coastal Cooking Challenge' : 'Matlagningsutmaning vid kusten'}
              </h3>
              <p className="text-gray-700">
                {lang === 'en' 
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-xl font-bold mb-2 text-blue-900">
                {lang === 'en' ? 'Historical Treasure Hunt' : 'Historisk skattjakt'}
              </h3>
              <p className="text-gray-700">
                {lang === 'en' 
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center">
            {t.activities?.title || (lang === 'en' ? 'Activities' : 'Aktiviteter')}
          </h2>
          <p className="text-center text-lg mb-8 max-w-4xl mx-auto">
            {t.activities?.description || (lang === 'en' 
              ? 'Complement your conference with one of our popular activities to strengthen team spirit and gain new perspectives.'
              : 'Komplettera er konferens med någon av våra populära aktiviteter för att stärka teamkänslan och få nya perspektiv.')}
          </p>
        ...
        <div className="mt-16 text-center">
          <h2 className="text-2xl font-bold mb-4">
            {t.contact?.title || (lang === 'en' ? 'Book Your Conference' : 'Boka er konferens')}
          </h2>
          <p className="text-gray-700 mb-2">
            {lang === 'en' ? 'For more information and booking, contact us at ' : 'För mer information och bokning, kontakta oss på '}
