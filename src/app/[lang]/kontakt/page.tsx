...
export default async function KontaktPage({
  ...
  const t = dict.kontakt || {
    title: lang === 'en' ? 'Contact Us' : 'Kontakta oss',
    subtitle: lang === 'en' ? 'We\'ll help you with your booking or questions' : 'Vi hjälper dig med din bokning eller dina frågor',
    info: {
      title: lang === 'en' ? 'Contact Information' : 'Kontaktuppgifter',
      address: {
        label: lang === 'en' ? 'Address' : 'Adress',
        street: 'Kyrkvägen 9',
        postal: '474 70 Mollösund',
        country: lang === 'en' ? 'Sweden' : 'Sverige'
      },
      phone: {
        label: lang === 'en' ? 'Phone' : 'Telefon',
        number: '0304-211 08'
      },
      email: {
      ...
      hours: {
        label: lang === 'en' ? 'Reception Hours' : 'Öppettider reception',
        weekdays: lang === 'en' ? 'Monday-Friday: 09:00-17:00' : 'Måndag-Fredag: 09:00-17:00',
        weekend: lang === 'en' ? 'Saturday-Sunday: 10:00-16:00' : 'Lördag-Söndag: 10:00-16:00',
        note: lang === 'en' ? 'Hours may vary depending on season' : 'Öppettider kan variera beroende på säsong'
      }
    },
    departments: {
      title: lang === 'en' ? 'Contact Us For' : 'Kontakta oss för',
      hotel: {
        title: lang === 'en' ? 'Hotel Booking' : 'Hotellbokning',
        description: lang === 'en' ? 'For questions about rooms and accommodation:' : 'För frågor om rum och boende:',
        email: 'hotell@wards.se',
        phone: '0304-211 08'
      },
      restaurant: {
        title: lang === 'en' ? 'Restaurant & Events' : 'Restaurang & Event',
        description: lang === 'en' ? 'For bookings and inquiries about private events:' : 'För bokningar och förfrågningar om privata evenemang:',
        email: 'restaurang@wards.se',
        phone: '0304-211 08'
      },
      conference: {
        title: lang === 'en' ? 'Conference' : 'Konferens',
        description: lang === 'en' ? 'For conference inquiries and group bookings:' : 'För konferensförfrågningar och gruppbokningar:',
        email: 'konferens@wards.se',
        phone: '0304-211 08'
      }
    },
    directions: {
      title: lang === 'en' ? 'Find Us' : 'Hitta hit',
      car: {
        title: lang === 'en' ? 'By Car' : 'Med bil',
        from: lang === 'en' ? 'From Gothenburg:' : 'Från Göteborg:',
        steps: lang === 'en' 
          ? [
        ...
        parking: lang === 'en' ? 'Parking is available near the inn.' : 'Parkering finns tillgänglig i närheten av värdshuset.'
      },
      public: {
        title: lang === 'en' ? 'By Public Transport' : 'Med kollektivtrafik',
        from: lang === 'en' ? 'From Gothenburg:' : 'Från Göteborg:',
        steps: lang === 'en'
          ? [
        ...
        note: lang === 'en' ? 'For current timetables, visit' : 'För aktuella tidtabeller, besök'
      }
    },
    faq: {
      title: lang === 'en' ? 'Frequently Asked Questions' : 'Vanliga frågor',
      questions: [
        {
          question: lang === 'en' ? 'What are the check-in and check-out times?' : 'Vilka tider är incheckning och utcheckning?',
          answer: lang === 'en' ? 'Check-in from 3:00 PM. Check-out by 11:00 AM.' : 'Incheckning från kl 15:00. Utcheckning senast kl 11:00.'
        },
        {
          question: lang === 'en' ? 'Is breakfast included in the room price?' : 'Är frukost inkluderad i rumspriset?',
          answer: lang === 'en' ? 'Yes, all room rates include breakfast.' : 'Ja, alla rumspriser inkluderar frukost.'
        },
        {
          question: lang === 'en' ? 'Is there parking available?' : 'Finns det parkering?',
          answer: lang === 'en' ? 'Yes, there is parking near the inn.' : 'Ja, det finns parkering i närheten av värdshuset.'
        },
        {
          question: lang === 'en' ? 'Are pets allowed?' : 'Är husdjur tillåtna?',
          answer: lang === 'en' 
        ...
        <div className="mb-16">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="mt-8">
                <h3 className="text-xl font-semibold mb-4">{lang === 'en' ? 'Follow Us' : 'Följ oss'}</h3>
