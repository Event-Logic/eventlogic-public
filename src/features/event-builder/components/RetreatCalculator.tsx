...
interface RetreatCalculatorProps {
  locale: Locale;
...
export function RetreatCalculator({
  ...
  const [attendees, setAttendees] = useState<number>(15);
      ...
      <CardContent className={cn("space-y-6", embedded ? "px-0" : "")}>
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="7">7 {t.calculator.days}</SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <SelectContent>
              {retreatPricingData.addOnCategories
