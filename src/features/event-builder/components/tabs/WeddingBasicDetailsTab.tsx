...
import { calculateBasePrice } from "../../data/wedding-pricing";
...
import { weddingPricingData, SelectedAddOn } from "../../data/wedding-pricing";

interface WeddingBasicDetailsTabProps {
  locale: Locale;
  ...
  setSelectedVenue: (venue: SelectedAddOn) => void;
  onContinue: () => void;
}

export function WeddingBasicDetailsTab({ 
  locale, 
  dictionary,
  date,
  setDate,
