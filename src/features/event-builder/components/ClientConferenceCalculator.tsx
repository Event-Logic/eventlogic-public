...
interface ClientConferenceCalculatorProps {
  locale: Locale;
...
export function ClientConferenceCalculator({
  locale,
  dictionary,
  embedded = false,
  onAddToCart
}: ClientConferenceCalculatorProps) {
  const t = dictionary;
  ...
  const totalPrice = date ? calculateTotalPrice(date, days, attendees, {}) : 0;
  ...
  const handleAddToCart = () => {
    ...
    onAddToCart({
      ...
      attendees,
      totalPrice,
      selectedAddOns: {}, // Add empty selectedAddOns object to satisfy the type
    });
  };
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="4">4 {t.calculator.days}</SelectItem>
              <SelectItem value="5">5 {t.calculator.days}</SelectItem>
            </SelectContent>
          </Select>
        </div>
